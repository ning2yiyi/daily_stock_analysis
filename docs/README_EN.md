...
| `MX_APIKEY` | [EastMoney MiaoXiang](https://marketing.dfcfs.com/views/finskillshub/indexIoMv0EzE) Financial news search (highest priority, authoritative CN source) | Optional |
